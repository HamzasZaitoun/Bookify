...
productItems.forEach(function(item) {
    item.addEventListener("click", function() {
        ...
        var productTitle = this.closest(".product-itemf").querySelector("h3").textContent;
        var productAuthor = this.closest(".product-itemf").querySelector("span").textContent;
        var productPrice = this.closest(".product-itemf").querySelector(".item-price").textContent;
